...
var sourceS3Conf = new AWS.Config({
  accessKeyId: process.env.HYPERCUBE_S3_KEY,           //replace this with the S3 Access Key for the source bucket
  secretAccessKey: process.env.HYPERCUBE_S3_SECRET  //replace this with the S3 Secret Access Key for the source bucket
});
